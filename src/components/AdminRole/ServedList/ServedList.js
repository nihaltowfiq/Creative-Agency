                ...
                <Col md={9}>
                    ...
                    <Container className="mt-2 py-3" style={{ backgroundColor: "#F4F7FC", height: '600px' }}>
                        <div className="bg-white p-4" style={{ borderRadius: '10px' }}>
                            <p className="text-center text-success" style={{ fontSize: "1.5em" }} id="update"></p>
                            {
                                orders.length === 0 &&
                            ...
                            <table className="table bg-white mt-4 text-center table-hover rounded table-borderless">
                                <thead className="bg-light">
                                    <tr>
                                        <th style={{ borderRadius: "10px 0 0 10px" }} scope="col">Name</th>
                                        <th scope="col">Email</th>
                                        <th scope="col">Service</th>
                                        <th scope="col">Details</th>
                                        <th style={{ borderRadius: "0 10px 10px 0" }} scope="col">Status</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    {
                                        orders.map(order =>
                                            <tr key={order._id}>
                                                ...
                                                <td className="text-left" width="300px">{order.details}</td>
                                                <td>
